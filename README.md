...
Official code implementation of OpenPSG, [arXiv](https://arxiv.org/abs/2407.11213).
...
## Preparation
Please use [OpenSeeD](https://github.com/franciszzj/OpenSeeD), and clone it into ```3rdparty/OpenSeeD```
