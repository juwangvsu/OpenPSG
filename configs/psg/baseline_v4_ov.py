...
custom_imports = dict(imports=[
    ...
    'kings_sgg.models.detectors.openseed_relation_v2',
    'kings_sgg.models.relation_heads.relation_transformer_head_v4',
    'kings_sgg.utils.part_checkpoint_hook',
...
model = dict(
    ...
    relation_head=dict(
        type='RelationTransformerHeadV4',
        qformer_model_name='Salesforce/instructblip-vicuna-7b',
        llm_model_name='meta-llama/Llama-2-7b-hf',
        relation_classes=relation_classes,
    ),
    train_cfg=dict(
        freeze_layers=['openseed', 'relation_head.language_model'],
    ),
    test_cfg=None,
    init_cfg=None)
...
workflow = [('train', 1)]
checkpoint_config = dict(type='PartCheckpointHook',
